...
function MadeByMeScreen({ navigation }) {
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
            ...
            headerRight: () => (
                <TouchableOpacity onPress={() => {
                    navigation.push('MakeNewPromise', {type: 'PROMISE'})
                }} style={{marginRight: 15}}>
                    <Image source={require('../assets/images/icon_new_promise.png')} style={{width: 34, height: 34, resizeMode: 'contain'}} />
                </TouchableOpacity>
            )
        })
    })
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: Colors.background}}>
            ...
            }
            {
                ...
                <View style={{width: Layouts.screenWidth, flex: 1, alignItems: 'center', paddingHorizontal: 0, paddingTop: 10}}>
                    <View style={{height: Layouts.screenHeight - (44 + insets.top) - (60 + insets.bottom) - 30 - (Platform.OS == 'android' ? 25 : 0), width: Layouts.screenWidth - 40, backgroundColor: Colors.primary_dark, justifyContent: 'center', alignItems: 'center'}}>
                        ...
                        <TouchableOpacity onPress={() => {                            
                            navigation.push('MakeNewPromise', {type: 'PROMISE'})
                        }} style={{position: 'absolute', bottom: 20, height: 50, width: Layouts.screenWidth - 80, borderRadius: 25, backgroundColor: Colors.green, alignItems: 'center', justifyContent: 'center'}}>
                            <Image source={require('../assets/images/icon_create_promise.png')} style={{position: 'absolute', left: 15, width: 30, height: 30, resizeMode: 'contain'}} />
                            <Text style={{marginStart: 20, fontFamily: 'Gotham-Medium', fontSize: 12, color: Colors.white}}>{'MAKE A NEW PROMISE'}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            }
                        ...
                        <View>
                            <Carousel
                                ...
                                onBeforeSnapToItem={(index) => {
                                    if (index == (state.promises.length - 1)) {
                                        loadPromises()
                                    }
                                }}
